...
RESIZE_WIDTH = 384      # Small resolution keeps CPU inference fast on the Pi
RESIZE_HEIGHT = 216

# ── Drive Loop Timing ────────────────────────────────────────────────
DRIVE_LOOP_HZ = 15      # 20 Hz = one update every 50 ms; fast enough for smooth driving
...
JOYSTICK_MAX_THROTTLE = 0.2         # Limit top speed during data collection for safety
...
# ── FPV Web Stream ────────────────────────────────────────────────────
USE_FPV = False         # Set True to stream the camera to http://<hostname>.local:8887# ── Image Transformations ────────────────────────────────────────────
...
AUGMENTATIONS = ['HUE_SAT', 'RGB_SHIFT', 'SUNFLARE', 'GAMMA', 'CLAHE']
ROI_CROP_TOP = 70
ROI_CROP_BOTTOM = 0
